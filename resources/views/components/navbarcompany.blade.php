        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-3">
                <ul class="navbar-nav ms-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('tentangKami') ? 'active' : '' }}" href="/perusahaan-tentangkami">Tentang Kami</a>
                    </li>
                </ul>
            </ul>
            <ul class="navbar-nav navbar-right-section">
                ...
                <li class="nav-item dropdown ms-3">
                    ...
                    <li class="nav-item mt-1"><a href="" class="btn btn-perusahaan ms-3">Untuk Pelamar</a></li>
